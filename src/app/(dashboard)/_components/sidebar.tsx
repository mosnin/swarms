...
const Icons = {
  ...
  simulations: (p: IconProps) => (<Svg {...p}><circle cx="7" cy="7" r="2.4" /><circle cx="17" cy="7" r="2.4" /><circle cx="12" cy="17" r="2.4" /><path d="M9.4 7h5.2M8 9.2l2.8 5.4M16 9.2l-2.8 5.4" /></Svg>),
  schedules: (p: IconProps) => (<Svg {...p}><circle cx="12" cy="12" r="8.5" /><path d="M12 7v5l3.5 2" /></Svg>),
  evaluations: (p: IconProps) => (<Svg {...p}><path d="M12 3l2.4 4.9 5.4.8-3.9 3.8.9 5.4-4.8-2.5-4.8 2.5.9-5.4L4.2 8.7l5.4-.8L12 3Z" /></Svg>),
  artifacts: (p: IconProps) => (<Svg {...p}><path d="M4 7a2 2 0 0 1 2-2h4l2 2h6a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V7Z" /></Svg>),
...
const GROUPS: { title: string; tree?: boolean; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/evaluations", label: "Evaluations", icon: Icons.evaluations },
